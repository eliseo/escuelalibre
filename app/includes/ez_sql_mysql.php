<?php
	...
	*	https://p3nlmysqladm001.secureserver.net/nl50/991/index.php?uniqueDnsEntry=waterhouseed.db.4288105.hostedresource.com
	=======
	*/
define('DB_NAME', 'waterhouseed');    
define('DB_USER', 'waterhouseed');    
define('DB_PASSWORD', 'h2F83xwLV'); 
define('DB_HOST', 'waterhouseed.db.4288105.hostedresource.com');
...
require_once('ez_sql_core.php');
	...
	if ( ! isset($mdb) )	
	$ndb = new ezSQL_mysql(DB_USER, DB_PASSWORD, DB_NAME, DB_HOST);
