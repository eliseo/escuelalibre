					...
					<table class="simple">
						<tbody>
							...
							<tr>
								<td>
									<div class="line">
										<label>Selecciona Maestro a cargo: </label>
									...
									<table>
										<tbody>
											<tr>
												<td>	
													<div class="line">
													<label>Fecha Inicia:</label> <input type="text" name="start_date" class="datepicker text" />
														</div>
												</td>
												<td>
													<div class="line">
														<label>Fecha Termina:</label> <input type="text" name="end_date" class="datepicker text"> 
													</div>
												</td>
											</tr>
										</tbody>
