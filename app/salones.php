...
<head>
	...
	<script type='text/javascript' src='modules/fullcalendar/js/fullcalendar.min.js'></script>
	...
	<link rel='stylesheet' type='text/css' href='modules/fullcalendar/css/fullcalendar.css' />	
				...
				<div class="colmask rightmenu">
					<div class="colleft">
							...
							<div id="page" class="col1">
								<!-- .begin full container-->
									<div class="span-full container_12">
										<form id="roomF">
											<div class="line">
												<label for="selectRoom">Elige Salón: </label>
												<select name="selectRoom" id="selectRoom"> </select>
											</div>
										</form>
						...
						<div class="col2">
							...
							<nav class="left">
								<ul>
									<li class="current"><a href="stats.html">Disponibilidad Salones</a></li>
								</ul>
							</nav>
							<!-- right menu [end] -->
