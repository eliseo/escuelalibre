...
<head>
	...
	<?php if( $ut->isTeacher() ){ ?>
			<script type="text/javascript" src="js/teacher-schedules.js"></script>
	<?php }elseif( $ut->isAdmin() ){ ?>
			<script type="text/javascript" src="js/admin-schedules.js"></script>
	<?php }elseif( $ut->isStudent() ){ ?>
			<script type="text/javascript" src="js/student-schedules.js"></script>
	<?php }?>
		...
		<div id="wrapper">
			...
			<div id="container">
				...
				<div class="colmask rightmenu">
					...
					<?php 
						if( $ut->isTeacher() ){
							include('view/teacher-schedules.php');
						}elseif( $ut->isAdmin() ){
							include('view/admin-schedules.php');
						}elseif( $ut->isStudent() ){
							include('view/student-schedules.php');
						}
					?>
						...
						<div class="col2">
							...
							<nav class="left">
								<ul>
									<li class="current"><a href="stats.html">Horarios</a></li>
								</ul>
							</nav>
							<!-- right menu [end] -->
