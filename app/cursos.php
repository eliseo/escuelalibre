								...
								<?php
									if($ut->isAdmin()){
										if(isset($_GET['id_course'])){
											include("view/admin-course-details.php");
										}else{
											include("view/admin-courses.php");
										}
									}elseif($ut->isTeacher()){
										include("view/teacher-courses.php");
									}elseif($ut->isStudent()){
										include("view/student-courses.php");
									}elseif($ut->isObserver()){
										include("view/observer-courses.php");
									}elseif($ut->isFrontDesk()){
										if(isset($_GET['id_course'])){
											include("view/frontdesk-course-details.php");
										}else{
											include("view/frontdesk-courses.php");
										}
									}
								?>
